...
public class DeviceControlActivity extends Activity {
    ...
    //or notification operations. 브로드 캐스트와 service를 연결 시켜 정보를 가져올수 있다
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mGattUpdateReceiver, makeGattUpdateIntentFilter()); //브로드 캐스트 등록
